...
验证者维护区块链网络，并在这个共识协议中验证交易，他们的努力会得到交易费的回报。该协议基于一个投票系统，在该系统中选出验证者来帮助新块的一致状态。拥有更多硬币的人拥有更多投票权。
...
Casper 是一个基于保证金的利益证明(PoS)协议模型。这意味着验证者必须存款，以便通过产生块来服务于共识。
...
因为它需要使用专门的硬件，PoET 协议最好用于无许可的公共分布式分类帐，不能被广泛采用。
