# Kotlin 与 Java 在 Android 开发中的对比
...
Java 以其 WORA 特性而闻名，意思是“写一次就可以在任何地方运行”。有了这种可移植性，您可以在任何平台上使用 Java。Java 创建一次静态成员，这些成员可以被类的所有实例共享。
...
Kotlin 有一个可互操作的语言特性，使得调用 Java 代码成为可能。它还可以利用 Kotlin 类型系统的全部功能，为 Java 脚本库创建外部声明。
